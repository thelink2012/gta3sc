...
{
public:
    MultifileCodeGen(const SymbolTable& symbol_table, const StorageTable& storage, DiagnosticHandler& diag) noexcept :
    ...
    bool generate(const LinkedIR<SemaIR>& ir, RelocationTable& reloc_table, std::vector<std::byte>& output);

...
{
    // CHECK:      REGISTER_STREAMED_SCRIPT_INTERNAL 0i8
    // CHECK-NEXT: REGISTER_STREAMED_SCRIPT_INTERNAL 1i8
    // CHECK-NEXT: REGISTER_STREAMED_SCRIPT_INTERNAL 2i8
    // CHECK-NEXT: REGISTER_STREAMED_SCRIPT_INTERNAL 3i8
    // CHECK-NEXT: REGISTER_STREAMED_SCRIPT_INTERNAL 4i8
    ...
    // CHECK-NEXT: REGISTER_ATTRACTOR_SCRIPT_BRAIN_FOR_CODE_USE 1i8 'DANCER'
    REGISTER_ATTRACTOR_SCRIPT_BRAIN_FOR_CODE_USE ATTR1 DANCER

    // CHECK-NEXT: REGISTER_SCRIPT_BRAIN_FOR_CODE_USE 2i8 'HOUSE'
    REGISTER_SCRIPT_BRAIN_FOR_CODE_USE BRAIN1 HOUSE

    // CHECK-NEXT: ALLOCATE_STREAMED_SCRIPT_TO_OBJECT 3i8 -1i8 100i8 0x1.800000p+2f 1i8
    ALLOCATE_STREAMED_SCRIPT_TO_OBJECT OBJKT1 KB_BANDIT_U 100 6.0 1

    // CHECK-NEXT: ALLOCATE_STREAMED_SCRIPT_TO_RANDOM_PED 4i8 28i8 100i8
    ALLOCATE_STREAMED_SCRIPT_TO_RANDOM_PED PED1 BMYDRUG 100

    // CHECK-NEXT: STREAM_SCRIPT 0i8
    STREAM_SCRIPT STREAM1

    // CHECK: NOT HAS_STREAMED_SCRIPT_LOADED 0i8
    WHILE NOT HAS_STREAMED_SCRIPT_LOADED STREAM1
        WAIT 0
    ENDWHILE

    // CHECK: START_NEW_STREAMED_SCRIPT 0i8
    START_NEW_STREAMED_SCRIPT STREAM1

    // CHECK-NEXT: MARK_STREAMED_SCRIPT_AS_NO_LONGER_NEEDED 0i8
    MARK_STREAMED_SCRIPT_AS_NO_LONGER_NEEDED STREAM1

    // CHECK-NEXT: GET_NUMBER_OF_INSTANCES_OF_STREAMED_SCRIPT 0i8 &8
    GET_NUMBER_OF_INSTANCES_OF_STREAMED_SCRIPT STREAM1 n
    WHILE n > 0
        // CHECK: GET_NUMBER_OF_INSTANCES_OF_STREAMED_SCRIPT 0i8 &8
        GET_NUMBER_OF_INSTANCES_OF_STREAMED_SCRIPT STREAM1 n
    ENDWHILE

    // CHECK: REMOVE_STREAMED_SCRIPT 0i8
    REMOVE_STREAMED_SCRIPT STREAM1

    // CHECK: SWITCH_OBJECT_BRAINS 0i8 1i8
...
// attractor1.sc
// CHECK-NEXT: #STREAMED_BLOCK_START 1
// CHECK-NEXT: PRINT_HELP 'ATTR1'
// CHECK-NEXT: TERMINATE_THIS_SCRIPT
// CHECK-NEXT: #STREAMED_BLOCK_END

// brain1.sc
// CHECK-NEXT: #STREAMED_BLOCK_START 2
// CHECK-NEXT: PRINT_HELP 'BRAIN1'
// CHECK-NEXT: TERMINATE_THIS_SCRIPT
// CHECK-NEXT: #STREAMED_BLOCK_END

// object1.sc
// CHECK-NEXT: #STREAMED_BLOCK_START 3
// CHECK-NEXT: PRINT_HELP 'OBJ1'
// CHECK-NEXT: GET_NUMBER_OF_INSTANCES_OF_STREAMED_SCRIPT 3i8 0@
// CHECK-NEXT: TERMINATE_THIS_SCRIPT
// CHECK-NEXT: #STREAMED_BLOCK_END

// ped1.sc
// CHECK-NEXT: #STREAMED_BLOCK_START 4
// CHECK-NEXT: PRINT_HELP 'PED1'
// CHECK-NEXT: TERMINATE_THIS_SCRIPT
// CHECK-NEXT: #STREAMED_BLOCK_END
